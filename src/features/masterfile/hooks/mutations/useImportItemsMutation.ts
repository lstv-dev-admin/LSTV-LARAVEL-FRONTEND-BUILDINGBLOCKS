...
const useImportItemsMutation = <TFormData extends Record<string, unknown>>({
	endpoint,
	queryKey,
	primaryKey,
	invalidateQueryKeys = [],
	...
	return useMutation({
		mutationFn: (payload: TFormData[]) => masterfileApi.import(endpoint, payload),
		onSuccess: () => {
...
export default useImportItemsMutation;